...
class TestQuestionRoutes:
    ...
    async def test_routes(
        ...
        res = await admin_client.get(app.url_path_for("question:get-list-for-category", category_id=category_id))
        assert res.status_code != status.HTTP_404_NOT_FOUND
        res = await admin_client.get(
            app.url_path_for("question:get-by-id", category_id=category_id, question_id=question_id),
        )
        assert res.status_code != status.HTTP_404_NOT_FOUND
        res = await admin_client.post(app.url_path_for("question:create", category_id=category_id))
        assert res.status_code != status.HTTP_404_NOT_FOUND
...
class TestCreateQuestion:
    ...
    async def test_unauthenticated_user_creates_question_raises_error(
            self,
            app: FastAPI,
            client: TestClient,
            empty_category: CategoryPublic,
    ...
    async def test_authenticated_non_admin_user_creates_question_raises_error(
            self,
            app: FastAPI,
...
class TestUpdateQuestion:
    ...
    async def test_unauthenticated_user_updates_question_raises_error(
            self,
            app: FastAPI,
            client: TestClient,
            category_with_one_question: CategoryPublic,
        ...
        res = await client.put(
            ...
            json={"question": "Non admin users can't modify questions"}
        )
        assert res.status_code == status.HTTP_401_UNAUTHORIZED
    
    async def test_authenticated_non_admin_user_updates_question_raises_error(
            self,
            app: FastAPI,
            authorized_client: TestClient,
            category_with_one_question: CategoryPublic,
...
class TestDeleteQuestion:
    ...
    async def test_delete_question_from_category(
        ...
        res = await admin_client.delete(app.url_path_for(
        ...
        confirm_res = await admin_client.get(app.url_path_for(
    ...
    async def test_unauthenticated_user_deletes_question_raises_error(
            self,
            app: FastAPI,
            client: TestClient,
            category_with_one_question: CategoryPublic
    ...
    async def test_authenticated_non_admin_user_deletes_question_raises_error(
            self,
            app: FastAPI,
            authorized_client: TestClient,
            category_with_one_question: CategoryPublic
    ) -> None:
        res = await authorized_client.delete(app.url_path_for(
            "question:delete-by-id",
            category_id=category_with_one_question.id,
            question_id=category_with_one_question.questions[0]["id"]
        ))
